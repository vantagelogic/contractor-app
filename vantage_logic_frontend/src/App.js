    ...
    <ScreenContainer>
      {!embedded && (
        <>
          <ScreenHeader
            title="Inventory"
            subtitle="Track materials and supplies on hand."
            action={!mobile && !readonly ? (
          ...
          />
          {importMsg && !mobile && <div style={{ fontSize: 12, color: theme.textSecondary, marginTop: 6, marginBottom: 8 }}>{importMsg}</div>}
        </>
      )}
